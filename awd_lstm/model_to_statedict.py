...
def convert_model_to_statedict(model_path="awd_lstm/test_v2.pt"):
    model = None
...
if __name__ == "__main__":
    model = convert_model_to_statedict("awd_lstm/test_v2.pt")

    torch.save(model.state_dict(), "awd_lstm/test_v2_statedict.pt")